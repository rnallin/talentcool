    ...
    <div className="min-h-screen bg-background overflow-hidden selection:bg-primary/20 selection:text-primary">
      ...
      <section className="pt-32 pb-20 md:pt-48 md:pb-32 px-4 relative">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[600px] overflow-hidden -z-10 pointer-events-none">
          <div className="absolute top-[-20%] left-[20%] w-[500px] h-[500px] rounded-full bg-[#145338]/8 blur-[100px]" />
          <div className="absolute top-[10%] right-[10%] w-[600px] h-[600px] rounded-full bg-[#2d8a5e]/8 blur-[120px]" />
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.h1 variants={fadeIn} className="text-5xl md:text-7xl font-bold tracking-tight text-foreground leading-[1.1] mb-6">
              Contrate os melhores <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#145338] to-[#2d8a5e]">talentos com inteligência</span>
            </motion.h1>
      ...
      <section id="metrics" className="py-20 bg-primary text-primary-foreground relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#145338] via-[#145338] to-[#000402]" />
      ...
      <section className="py-24 px-4 overflow-hidden">
        <div className="max-w-7xl mx-auto space-y-32">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              <div className="relative">
                <div className="absolute inset-0 bg-[#145338]/15 rounded-3xl blur-2xl transform translate-x-4 translate-y-4" />
                <img 
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            ...
            >
              <div className="relative">
                <div className="absolute inset-0 bg-[#2d8a5e]/15 rounded-3xl blur-2xl transform -translate-x-4 translate-y-4" />
                <img 
      ...
      <section className="py-24 px-4 relative overflow-hidden">
        <div className="absolute inset-0 bg-[#145338]" />
        <div className="absolute inset-0 bg-gradient-to-br from-[#145338] via-[#6A6E6C] to-[#000402]" />
        {/* Abstract pattern */}
